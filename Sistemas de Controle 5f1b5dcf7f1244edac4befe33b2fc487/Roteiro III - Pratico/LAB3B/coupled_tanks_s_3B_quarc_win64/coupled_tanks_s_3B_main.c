...
typedef RT_MODEL_coupled_tanks_s_3B_T RT_MODEL;

/*====================*
 * External functions *
 *====================*/
EXTERN RT_MODEL * coupled_tanks_s_3B(void);
  ...
  _do_assertion(const char * expression, const char * file_name, int line_number)
{
  ...
  rtmSetErrorStatus(coupled_tanks_s_3B_M, GBLbuf.message);
}
  ...
  main(int argc, char * argv[])
{
  ...
  if (parseError) {
    (void) fprintf(stderr,
                   "\nUsage: coupled_tanks_s_3B -option1 val1 -option2 val2 -option3 ...\n\n");
    (void) fprintf(stderr,
