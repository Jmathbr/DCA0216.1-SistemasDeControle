...
P_coupled_tanks_s_3C_T coupled_tanks_s_3C_P = {
  /*  Variable: A
   ...
   */
  { 0.0, 1.0 },
  -0.50132267806183417,                /* Variable: K1
   ...
   */
  { -1.3383629722411849, -4.8355641714705166 },

  /*  Variable: L
   * Referenced by: '<Root>/L'
   */
  { 27.53263665784311, 2.8687103728373704 },
