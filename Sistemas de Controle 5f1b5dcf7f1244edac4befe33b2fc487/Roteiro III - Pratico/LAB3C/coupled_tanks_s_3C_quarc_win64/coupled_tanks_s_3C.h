...
#ifndef RTW_HEADER_coupled_tanks_s_3C_h_
#define RTW_HEADER_coupled_tanks_s_3C_h_
#include <string.h>
#ifndef coupled_tanks_s_3C_COMMON_INCLUDES_
# define coupled_tanks_s_3C_COMMON_INCLUDES_
#include "rtwtypes.h"
...
#endif                                 /* coupled_tanks_s_3C_COMMON_INCLUDES_ */

#include "coupled_tanks_s_3C_types.h"
...
#define coupled_tanks_s_3C_rtModel     RT_MODEL_coupled_tanks_s_3C_T

/* Block signals (auto storage) */
typedef struct {
  real_T VoltstocmTank1;               /* '<S7>/Volts to cm Tank 1 ' */
  real_T VoltstocmTank2;               /* '<S7>/Volts to cm Tank 2' */
  real_T Estimado[2];                  /* '<Root>/Integrator' */
  real_T Sinaisdecontrolenosaturado;   /* '<Root>/Sum6' */
  real_T Sinaisdecontrolesaturado;     /* '<Root>/Multiport Switch' */
  real_T errot1;                       /* '<Root>/Sum2' */
  real_T errot2;                       /* '<Root>/Sum3' */
  real_T Referncia;                    /* '<Root>/Constant' */
  real_T Sum[2];                       /* '<Root>/Sum' */
  real_T Sum5;                         /* '<Root>/Sum5' */
  boolean_T Compare;                   /* '<S4>/Compare' */
  boolean_T Compare_b;                 /* '<S2>/Compare' */
} B_coupled_tanks_s_3C_T;
...
typedef struct {
  ...
  real_T HILReadAnalog_Buffer[2];      /* '<S7>/HIL Read Analog' */
  ...
  struct {
    void *LoggedData;
  } Errosdeestimativa_PWORK;           /* '<Root>/Erros de estimativa' */

  struct {
    void *LoggedData;
  } Nveis_PWORK;                       /* '<Root>/Níveis' */

  struct {
    void *LoggedData;
  } Sinaisdecontrole_PWORK;            /* '<Root>/Sinais de controle' */
...
#define rtB                            coupled_tanks_s_3C_B
#define BlockIO                        B_coupled_tanks_s_3C_T
#define rtX                            coupled_tanks_s_3C_X
#define ContinuousStates               X_coupled_tanks_s_3C_T
#define rtXdot                         coupled_tanks_s_3C_XDot
#define StateDerivatives               XDot_coupled_tanks_s_3C_T
#define tXdis                          coupled_tanks_s_3C_XDis
#define StateDisabled                  XDis_coupled_tanks_s_3C_T
#define rtP                            coupled_tanks_s_3C_P
#define Parameters                     P_coupled_tanks_s_3C_T
#define rtDWork                        coupled_tanks_s_3C_DW
#define D_Work                         DW_coupled_tanks_s_3C_T

/* Parameters (auto storage) */
struct P_coupled_tanks_s_3C_T_ {
  ...
  real_T HILInitialize_set_other_outpu_n;/* Mask Parameter: HILInitialize_set_other_outpu_n
                                          * Referenced by: '<S7>/HIL Initialize'
                                          */
  real_T HILInitialize_set_other_outp_b2;/* Mask Parameter: HILInitialize_set_other_outp_b2
                                          * Referenced by: '<S7>/HIL Initialize'
                                          */
  ...
  boolean_T HILInitialize_set_analog_input_;/* Mask Parameter: HILInitialize_set_analog_input_
                                             * Referenced by: '<S7>/HIL Initialize'
                                             */
  boolean_T HILInitialize_set_analog_inpu_n;/* Mask Parameter: HILInitialize_set_analog_inpu_n
                                             * Referenced by: '<S7>/HIL Initialize'
                                             */
  ...
  boolean_T HILInitialize_set_analog_outp_j;/* Mask Parameter: HILInitialize_set_analog_outp_j
                                             * Referenced by: '<S7>/HIL Initialize'
                                             */
  boolean_T HILInitialize_set_analog_out_jf;/* Mask Parameter: HILInitialize_set_analog_out_jf
                                             * Referenced by: '<S7>/HIL Initialize'
                                             */
  ...
  boolean_T HILInitialize_set_encoder_param;/* Mask Parameter: HILInitialize_set_encoder_param
                                             * Referenced by: '<S7>/HIL Initialize'
                                             */
  boolean_T HILInitialize_set_encoder_par_o;/* Mask Parameter: HILInitialize_set_encoder_par_o
                                             * Referenced by: '<S7>/HIL Initialize'
                                             */
  ...
  boolean_T HILInitialize_set_pwm_params_at;/* Mask Parameter: HILInitialize_set_pwm_params_at
                                             * Referenced by: '<S7>/HIL Initialize'
                                             */
  boolean_T HILInitialize_set_pwm_params__o;/* Mask Parameter: HILInitialize_set_pwm_params__o
                                             * Referenced by: '<S7>/HIL Initialize'
                                             */
  ...
  boolean_T HILWriteAnalog_Active;     /* Computed Parameter: HILWriteAnalog_Active
                                        * Referenced by: '<S7>/HIL Write Analog'
                                        */
  uint8_T K2_Gain;                     /* Computed Parameter: K2_Gain
                                        * Referenced by: '<Root>/K2'
                                        */
};

/* Real-time Model Data Structure */
struct tag_RTM_coupled_tanks_s_3C_T {
  const char_T *path;
...
extern P_coupled_tanks_s_3C_T coupled_tanks_s_3C_P;

/* Block signals (auto storage) */
extern B_coupled_tanks_s_3C_T coupled_tanks_s_3C_B;

/* Continuous states (auto storage) */
extern X_coupled_tanks_s_3C_T coupled_tanks_s_3C_X;

/* Block states (auto storage) */
extern DW_coupled_tanks_s_3C_T coupled_tanks_s_3C_DW;

/* Model entry point functions */
extern void coupled_tanks_s_3C_initialize(void);
extern void coupled_tanks_s_3C_output(void);
extern void coupled_tanks_s_3C_update(void);
extern void coupled_tanks_s_3C_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern coupled_tanks_s_3C_rtModel *coupled_tanks_s_3C(void);
...
extern RT_MODEL_coupled_tanks_s_3C_T *const coupled_tanks_s_3C_M;
 ...
 *
 * '<Root>' : 'coupled_tanks_s_3C'
 * '<S1>'   : 'coupled_tanks_s_3C/Compare To Constant'
 * '<S2>'   : 'coupled_tanks_s_3C/Compare To Constant1'
 * '<S3>'   : 'coupled_tanks_s_3C/Compare To Constant2'
 * '<S4>'   : 'coupled_tanks_s_3C/Compare To Constant3'
 * '<S5>'   : 'coupled_tanks_s_3C/Compare To Constant4'
 * '<S6>'   : 'coupled_tanks_s_3C/Compare To Constant6'
 * '<S7>'   : 'coupled_tanks_s_3C/PLANTA'
 */
#endif                                 /* RTW_HEADER_coupled_tanks_s_3C_h_ */
