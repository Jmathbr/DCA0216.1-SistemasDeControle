...
#ifndef RTW_HEADER_coupled_tanks_s_h_
#define RTW_HEADER_coupled_tanks_s_h_
#include <string.h>
#ifndef coupled_tanks_s_COMMON_INCLUDES_
# define coupled_tanks_s_COMMON_INCLUDES_
#include "rtwtypes.h"
...
#endif                                 /* coupled_tanks_s_COMMON_INCLUDES_ */

#include "coupled_tanks_s_types.h"
...
#define coupled_tanks_s_rtModel        RT_MODEL_coupled_tanks_s_T
...
typedef struct {
  ...
  real_T Ki1;                          /* '<Root>/Ki  1' */
  real_T Constant1;                    /* '<Root>/Constant1' */
  real_T Sum4;                         /* '<Root>/Sum4' */
  real_T Kp1;                          /* '<Root>/Kp 1' */
  real_T Kd1;                          /* '<Root>/Kd 1' */
  ...
  boolean_T Compare_f;                 /* '<S2>/Compare' */
} B_coupled_tanks_s_T;
...
typedef struct {
  ...
  real_T TimeStampA_b;                 /* '<Root>/Derivative' */
  real_T LastUAtTimeA_p;               /* '<Root>/Derivative' */
  real_T TimeStampB_b;                 /* '<Root>/Derivative' */
  real_T LastUAtTimeB_k;               /* '<Root>/Derivative' */
...
#define rtB                            coupled_tanks_s_B
#define BlockIO                        B_coupled_tanks_s_T
#define rtX                            coupled_tanks_s_X
#define ContinuousStates               X_coupled_tanks_s_T
#define rtXdot                         coupled_tanks_s_XDot
#define StateDerivatives               XDot_coupled_tanks_s_T
#define tXdis                          coupled_tanks_s_XDis
#define StateDisabled                  XDis_coupled_tanks_s_T
#define rtP                            coupled_tanks_s_P
#define Parameters                     P_coupled_tanks_s_T
#define rtDWork                        coupled_tanks_s_DW
#define D_Work                         DW_coupled_tanks_s_T

/* Parameters (auto storage) */
struct P_coupled_tanks_s_T_ {
  ...
  real_T Ki1_Gain;                     /* Expression: 0.1
                                        * Referenced by: '<Root>/Ki  1'
                                        */
  real_T Constant1_Value;              /* Expression: 10
                                        * Referenced by: '<Root>/Constant1'
                                        */
  real_T Kp1_Gain;                     /* Expression: 2
                                        * Referenced by: '<Root>/Kp 1'
                                        */
  real_T Kd1_Gain;                     /* Expression: 0.02
                                        * Referenced by: '<Root>/Kd 1'
                                        */
  real_T Kp_Gain;                      /* Expression: 3
  ...
  real_T Integrator_IC;                /* Expression: 0
                                        ...
                                        */
  real_T KAW_Gain;                     /* Expression: 0.05
                                        * Referenced by: '<Root>/KAW '
                                        */
  real_T Ki_Gain;                      /* Expression: 0.2
...
struct tag_RTM_coupled_tanks_s_T {
  const char_T *path;
...
extern P_coupled_tanks_s_T coupled_tanks_s_P;

/* Block signals (auto storage) */
extern B_coupled_tanks_s_T coupled_tanks_s_B;

/* Continuous states (auto storage) */
extern X_coupled_tanks_s_T coupled_tanks_s_X;

/* Block states (auto storage) */
extern DW_coupled_tanks_s_T coupled_tanks_s_DW;

/* Model entry point functions */
extern void coupled_tanks_s_initialize(void);
extern void coupled_tanks_s_output(void);
extern void coupled_tanks_s_update(void);
extern void coupled_tanks_s_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern coupled_tanks_s_rtModel *coupled_tanks_s(void);
...
extern RT_MODEL_coupled_tanks_s_T *const coupled_tanks_s_M;
 ...
 *
 * '<Root>' : 'coupled_tanks_s'
 * '<S1>'   : 'coupled_tanks_s/Compare To Constant'
 * '<S2>'   : 'coupled_tanks_s/Compare To Constant1'
 * '<S3>'   : 'coupled_tanks_s/Compare To Constant2'
 * '<S4>'   : 'coupled_tanks_s/Compare To Constant3'
 * '<S5>'   : 'coupled_tanks_s/Compare To Constant4'
 * '<S6>'   : 'coupled_tanks_s/Compare To Constant5'
 * '<S7>'   : 'coupled_tanks_s/PLANTA'
 */
#endif                                 /* RTW_HEADER_coupled_tanks_s_h_ */
