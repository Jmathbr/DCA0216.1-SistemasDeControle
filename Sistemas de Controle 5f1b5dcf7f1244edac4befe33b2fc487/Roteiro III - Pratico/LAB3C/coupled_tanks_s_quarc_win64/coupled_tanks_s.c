...
void coupled_tanks_s_output(void)
{
  ...
  if (rtmIsMajorTimeStep(coupled_tanks_s_M)) {
    ...
    /* S-Function Block: coupled_tanks_s/PLANTA/HIL Read Analog (hil_read_analog_block) */
    {
      ...
      rtb_HILReadAnalog_o1 = coupled_tanks_s_DW.HILReadAnalog_Buffer[0];
      rtb_HILReadAnalog_o2 = coupled_tanks_s_DW.HILReadAnalog_Buffer[1];
    }

    /* Gain: '<S7>/Volts to cm Tank 1 ' */
    coupled_tanks_s_B.VoltstocmTank1 = coupled_tanks_s_P.VoltstocmTank1_Gain *
      rtb_HILReadAnalog_o1;

    /* Gain: '<S7>/Volts to cm Tank 2' */
    coupled_tanks_s_B.VoltstocmTank2 = coupled_tanks_s_P.VoltstocmTank2_Gain *
      rtb_HILReadAnalog_o2;

    /* RelationalOperator: '<S4>/Compare' incorporates:
     *  Constant: '<S4>/Constant'
     */
    coupled_tanks_s_B.Compare = (coupled_tanks_s_B.VoltstocmTank1 <=
      coupled_tanks_s_P.CompareToConstant3_const);

    /* Constant: '<Root>/Constant1' */
    coupled_tanks_s_B.Constant1 = coupled_tanks_s_P.Constant1_Value;

    /* Sum: '<Root>/Sum4' */
    coupled_tanks_s_B.Sum4 = coupled_tanks_s_B.Constant1 -
      coupled_tanks_s_B.VoltstocmTank2;

    /* Gain: '<Root>/Kp 1' */
    coupled_tanks_s_B.Kp1 = coupled_tanks_s_P.Kp1_Gain * coupled_tanks_s_B.Sum4;
  }

  /* Integrator: '<Root>/Integrator2' */
  coupled_tanks_s_B.Integrator2 = coupled_tanks_s_X.Integrator2_CSTATE;

  /* Gain: '<Root>/Ki  1' incorporates:
   *  Integrator: '<Root>/Integrator1'
   */
  coupled_tanks_s_B.Ki1 = coupled_tanks_s_P.Ki1_Gain *
    coupled_tanks_s_X.Integrator1_CSTATE;
  ...
  if ((coupled_tanks_s_DW.TimeStampA >= coupled_tanks_s_M->Timing.t[0]) &&
    ...
    rtb_Sum = coupled_tanks_s_DW.TimeStampA;
    ...
    if (coupled_tanks_s_DW.TimeStampA < coupled_tanks_s_DW.TimeStampB) {
      if (coupled_tanks_s_DW.TimeStampB < coupled_tanks_s_M->Timing.t[0]) {
        rtb_Sum = coupled_tanks_s_DW.TimeStampB;
    ...
    rtb_Sum = (coupled_tanks_s_B.Sum4 - *lastU) / (coupled_tanks_s_M->Timing.t[0]
      - rtb_Sum);
  }
  ...
  /* Gain: '<Root>/Kd 1' */
  coupled_tanks_s_B.Kd1 = coupled_tanks_s_P.Kd1_Gain * rtb_Sum;

  /* Sum: '<Root>/Sum3' */
  coupled_tanks_s_B.Sum3 = (coupled_tanks_s_B.Ki1 + coupled_tanks_s_B.Kp1) +
    coupled_tanks_s_B.Kd1;

  /* Sum: '<Root>/Sum2' */
  coupled_tanks_s_B.Sum2 = coupled_tanks_s_B.Sum3 -
  ...
  if ((coupled_tanks_s_DW.TimeStampA_b >= coupled_tanks_s_M->Timing.t[0]) &&
      (coupled_tanks_s_DW.TimeStampB_b >= coupled_tanks_s_M->Timing.t[0])) {
    rtb_Sum = 0.0;
  } else {
    rtb_Sum = coupled_tanks_s_DW.TimeStampA_b;
    lastU = &coupled_tanks_s_DW.LastUAtTimeA_p;
    if (coupled_tanks_s_DW.TimeStampA_b < coupled_tanks_s_DW.TimeStampB_b) {
      if (coupled_tanks_s_DW.TimeStampB_b < coupled_tanks_s_M->Timing.t[0]) {
        rtb_Sum = coupled_tanks_s_DW.TimeStampB_b;
        lastU = &coupled_tanks_s_DW.LastUAtTimeB_k;
      }
    } else {
      if (coupled_tanks_s_DW.TimeStampA_b >= coupled_tanks_s_M->Timing.t[0]) {
        rtb_Sum = coupled_tanks_s_DW.TimeStampB_b;
    ...
    rtb_Sum = (coupled_tanks_s_B.Sum2 - *lastU) / (coupled_tanks_s_M->Timing.t[0]
      - rtb_Sum);
  }
  ...
  /* Gain: '<Root>/Kd ' */
  coupled_tanks_s_B.Kd = coupled_tanks_s_P.Kd_Gain * rtb_Sum;

  /* Sum: '<Root>/Sum' */
  rtb_Sum = (coupled_tanks_s_B.Integrator2 + coupled_tanks_s_B.Kp) +
    coupled_tanks_s_B.Kd;
  if (rtmIsMajorTimeStep(coupled_tanks_s_M)) {
    /* RelationalOperator: '<S2>/Compare' incorporates:
     *  Constant: '<S2>/Constant'
     */
    coupled_tanks_s_B.Compare_f = (coupled_tanks_s_B.VoltstocmTank1 >=
      coupled_tanks_s_P.CompareToConstant1_const);
  }

  /* Saturate: '<Root>/Saturation' */
  if (rtb_Sum > coupled_tanks_s_P.Saturation_UpperSat) {
    coupled_tanks_s_B.Saturation = coupled_tanks_s_P.Saturation_UpperSat;
  } else if (rtb_Sum < coupled_tanks_s_P.Saturation_LowerSat) {
    coupled_tanks_s_B.Saturation = coupled_tanks_s_P.Saturation_LowerSat;
  } else {
    coupled_tanks_s_B.Saturation = rtb_Sum;
  }
  ...
  switch ((int32_T)((coupled_tanks_s_P.Constant2_Value - (real_T)
                     (coupled_tanks_s_B.Compare && (rtb_Sum <
              coupled_tanks_s_P.CompareToConstant_const))) - (real_T)((rtb_Sum >=
             coupled_tanks_s_P.CompareToConstant2_const) &&
            coupled_tanks_s_B.Compare_f ? (int32_T)coupled_tanks_s_P.K2_Gain : 0)
                    * 0.015625)) {
   case 1:
   ...
   default:
    coupled_tanks_s_B.MultiportSwitch = coupled_tanks_s_B.Saturation;
    break;
  }
  ...
  if (rtmIsMajorTimeStep(coupled_tanks_s_M)) {
     ...
     */
    if (coupled_tanks_s_B.VoltstocmTank1 >=
     ...
     */
    if (coupled_tanks_s_B.VoltstocmTank2 >=
   ...
   *  Sum: '<Root>/Sum6'
   */
  coupled_tanks_s_B.Sum5 = (coupled_tanks_s_B.Saturation - rtb_Sum) *
    coupled_tanks_s_P.KAW_Gain + coupled_tanks_s_P.Ki_Gain *
    coupled_tanks_s_X.Integrator_CSTATE;
}
...
void coupled_tanks_s_update(void)
{
  ...
  *lastU = coupled_tanks_s_B.Sum4;

  /* End of Update for Derivative: '<Root>/Derivative1' */

  /* Update for Derivative: '<Root>/Derivative' */
  if (coupled_tanks_s_DW.TimeStampA_b == (rtInf)) {
    coupled_tanks_s_DW.TimeStampA_b = coupled_tanks_s_M->Timing.t[0];
    lastU = &coupled_tanks_s_DW.LastUAtTimeA_p;
  } else if (coupled_tanks_s_DW.TimeStampB_b == (rtInf)) {
    coupled_tanks_s_DW.TimeStampB_b = coupled_tanks_s_M->Timing.t[0];
    lastU = &coupled_tanks_s_DW.LastUAtTimeB_k;
  } else if (coupled_tanks_s_DW.TimeStampA_b < coupled_tanks_s_DW.TimeStampB_b)
  {
    coupled_tanks_s_DW.TimeStampA_b = coupled_tanks_s_M->Timing.t[0];
    lastU = &coupled_tanks_s_DW.LastUAtTimeA_p;
  } else {
...
void coupled_tanks_s_derivatives(void)
{
  ...
  _rtXdot->Integrator2_CSTATE = coupled_tanks_s_B.Sum5;

  /* Derivatives for Integrator: '<Root>/Integrator1' */
  _rtXdot->Integrator1_CSTATE = coupled_tanks_s_B.Sum4;
...
void coupled_tanks_s_initialize(void)
{
  ...
  coupled_tanks_s_X.Integrator2_CSTATE = coupled_tanks_s_P.Integrator2_IC;

  /* InitializeConditions for Integrator: '<Root>/Integrator1' */
  coupled_tanks_s_X.Integrator1_CSTATE = coupled_tanks_s_P.Integrator1_IC;
  ...
  coupled_tanks_s_DW.TimeStampA_b = (rtInf);
  coupled_tanks_s_DW.TimeStampB_b = (rtInf);
...
RT_MODEL_coupled_tanks_s_T *coupled_tanks_s(void)
{
  ...
  /* External mode info */
  coupled_tanks_s_M->Sizes.checksums[0] = (1231088822U);
  coupled_tanks_s_M->Sizes.checksums[1] = (3978686791U);
  coupled_tanks_s_M->Sizes.checksums[2] = (873932932U);
  coupled_tanks_s_M->Sizes.checksums[3] = (538253377U);
  ...
  {
    coupled_tanks_s_B.VoltstocmTank1 = 0.0;
    coupled_tanks_s_B.VoltstocmTank2 = 0.0;
    coupled_tanks_s_B.Integrator2 = 0.0;
    coupled_tanks_s_B.Ki1 = 0.0;
    coupled_tanks_s_B.Constant1 = 0.0;
    coupled_tanks_s_B.Sum4 = 0.0;
    coupled_tanks_s_B.Kp1 = 0.0;
    coupled_tanks_s_B.Kd1 = 0.0;
    coupled_tanks_s_B.Sum3 = 0.0;
    coupled_tanks_s_B.Sum2 = 0.0;
    coupled_tanks_s_B.Kp = 0.0;
    coupled_tanks_s_B.Kd = 0.0;
    coupled_tanks_s_B.Saturation = 0.0;
    coupled_tanks_s_B.MultiportSwitch = 0.0;
    coupled_tanks_s_B.Sum5 = 0.0;
  }
  ...
  coupled_tanks_s_DW.TimeStampA_b = 0.0;
  coupled_tanks_s_DW.LastUAtTimeA_p = 0.0;
  coupled_tanks_s_DW.TimeStampB_b = 0.0;
  coupled_tanks_s_DW.LastUAtTimeB_k = 0.0;
  ...
  /* Initialize Sizes */
  coupled_tanks_s_M->Sizes.numContStates = (3);/* Number of continuous states */
  ...
  coupled_tanks_s_M->Sizes.numBlocks = (50);/* Number of blocks */
  coupled_tanks_s_M->Sizes.numBlockIO = (17);/* Number of block outputs */
  coupled_tanks_s_M->Sizes.numBlockPrms = (124);/* Sum of parameter "widths" */
