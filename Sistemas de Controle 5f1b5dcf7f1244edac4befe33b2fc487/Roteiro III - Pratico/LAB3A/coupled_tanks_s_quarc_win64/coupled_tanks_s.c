...
void coupled_tanks_s_output(void)
{
  ...
  if (rtmIsMajorTimeStep(coupled_tanks_s_M)) {
    ...
    coupled_tanks_s_B.Constant = coupled_tanks_s_P.Constant_Value;
  ...
  coupled_tanks_s_B.Integrator[0] = coupled_tanks_s_X.Integrator_CSTATE[0];
  coupled_tanks_s_B.Integrator[1] = coupled_tanks_s_X.Integrator_CSTATE[1];

  /* Sum: '<Root>/Sum2' */
  coupled_tanks_s_B.errot1 = coupled_tanks_s_B.VoltstocmTank1 -
    coupled_tanks_s_B.Integrator[0];

  /* Sum: '<Root>/Sum3' */
  coupled_tanks_s_B.errot2 = coupled_tanks_s_B.VoltstocmTank2 -
    coupled_tanks_s_B.Integrator[1];
  if (rtmIsMajorTimeStep(coupled_tanks_s_M)) {
    ...
    /* Gain: '<Root>/B' */
    coupled_tanks_s_B.B[0] = coupled_tanks_s_P.B[0] * coupled_tanks_s_B.Constant;
    coupled_tanks_s_B.B[1] = coupled_tanks_s_P.B[1] * coupled_tanks_s_B.Constant;
  }

  /* Sum: '<Root>/Sum1' incorporates:
   *  Gain: '<Root>/C'
   */
  rtb_Sum1 = coupled_tanks_s_B.VoltstocmTank2 - (coupled_tanks_s_P.C[0] *
    coupled_tanks_s_B.Integrator[0] + coupled_tanks_s_P.C[1] *
    coupled_tanks_s_B.Integrator[1]);
   ...
   *  Gain: '<Root>/L'
   */
  coupled_tanks_s_B.Sum[0] = (coupled_tanks_s_P.L[0] * rtb_Sum1 +
    coupled_tanks_s_B.B[0]) + (coupled_tanks_s_P.A[0] *
    coupled_tanks_s_B.Integrator[0] + coupled_tanks_s_P.A[2] *
    coupled_tanks_s_B.Integrator[1]);
  coupled_tanks_s_B.Sum[1] = (coupled_tanks_s_P.L[1] * rtb_Sum1 +
    coupled_tanks_s_B.B[1]) + (coupled_tanks_s_P.A[1] *
    coupled_tanks_s_B.Integrator[0] + coupled_tanks_s_P.A[3] *
    coupled_tanks_s_B.Integrator[1]);
}
...
void coupled_tanks_s_derivatives(void)
{
  ...
  _rtXdot->Integrator_CSTATE[0] = coupled_tanks_s_B.Sum[0];
  _rtXdot->Integrator_CSTATE[1] = coupled_tanks_s_B.Sum[1];
}
...
void coupled_tanks_s_initialize(void)
{
  ...
  /* S-Function Block: coupled_tanks_s/PLANTA/HIL Initialize (hil_initialize_block) */
  {
    ...
    if ((coupled_tanks_s_P.HILInitialize_set_analog_input_ && !is_switching) ||
        (coupled_tanks_s_P.HILInitialize_set_analog_inpu_n && is_switching)) {
      {
        int_T i1;
    ...
    if ((coupled_tanks_s_P.HILInitialize_set_analog_output && !is_switching) ||
        (coupled_tanks_s_P.HILInitialize_set_analog_outp_f && is_switching)) {
      {
        int_T i1;
    ...
    if ((coupled_tanks_s_P.HILInitialize_set_analog_outp_d && !is_switching) ||
        (coupled_tanks_s_P.HILInitialize_set_analog_outp_m && is_switching)) {
      {
        int_T i1;
    ...
    if (coupled_tanks_s_P.HILInitialize_set_analog_outp_h) {
      {
        int_T i1;
        real_T *dw_AOVoltages = &coupled_tanks_s_DW.HILInitialize_AOVoltages[0];
        for (i1=0; i1 < 8; i1++) {
    ...
    if ((coupled_tanks_s_P.HILInitialize_set_encoder_param && !is_switching) ||
        (coupled_tanks_s_P.HILInitialize_set_encoder_par_o && is_switching)) {
      {
        int_T i1;
    ...
    if ((coupled_tanks_s_P.HILInitialize_set_encoder_count && !is_switching) ||
        (coupled_tanks_s_P.HILInitialize_set_encoder_cou_n && is_switching)) {
      {
        int_T i1;
    ...
    if ((coupled_tanks_s_P.HILInitialize_set_pwm_params_at && !is_switching) ||
        (coupled_tanks_s_P.HILInitialize_set_pwm_params__o && is_switching)) {
    ...
    if ((coupled_tanks_s_P.HILInitialize_set_pwm_outputs_a && !is_switching) ||
        (coupled_tanks_s_P.HILInitialize_set_pwm_outputs_k && is_switching)) {
      {
        int_T i1;
        real_T *dw_POValues = &coupled_tanks_s_DW.HILInitialize_POValues[0];
        for (i1=0; i1 < 8; i1++) {
  ...
  coupled_tanks_s_X.Integrator_CSTATE[0] = coupled_tanks_s_P.Integrator_IC;
  coupled_tanks_s_X.Integrator_CSTATE[1] = coupled_tanks_s_P.Integrator_IC;
}
...
void coupled_tanks_s_terminate(void)
{
  ...
  /* S-Function Block: coupled_tanks_s/PLANTA/HIL Initialize (hil_initialize_block) */
  {
    ...
    is_switching = false;
    if ((coupled_tanks_s_P.HILInitialize_set_analog_out_jf && !is_switching) ||
        (coupled_tanks_s_P.HILInitialize_set_analog_outp_j && is_switching)) {
      {
        int_T i1;
        real_T *dw_AOVoltages = &coupled_tanks_s_DW.HILInitialize_AOVoltages[0];
        for (i1=0; i1 < 8; i1++) {
    ...
    if ((coupled_tanks_s_P.HILInitialize_set_pwm_outputs_d && !is_switching) ||
        (coupled_tanks_s_P.HILInitialize_set_pwm_outputs_c && is_switching)) {
      {
        int_T i1;
        real_T *dw_POValues = &coupled_tanks_s_DW.HILInitialize_POValues[0];
        for (i1=0; i1 < 8; i1++) {
...
RT_MODEL_coupled_tanks_s_T *coupled_tanks_s(void)
{
  ...
  /* External mode info */
  coupled_tanks_s_M->Sizes.checksums[0] = (1632739018U);
  coupled_tanks_s_M->Sizes.checksums[1] = (2302162008U);
  coupled_tanks_s_M->Sizes.checksums[2] = (801454693U);
  coupled_tanks_s_M->Sizes.checksums[3] = (1630479318U);
...

  {
    ...
    coupled_tanks_s_B.Constant = 0.0;
    coupled_tanks_s_B.Integrator[0] = 0.0;
    coupled_tanks_s_B.Integrator[1] = 0.0;
    coupled_tanks_s_B.errot1 = 0.0;
    coupled_tanks_s_B.errot2 = 0.0;
    coupled_tanks_s_B.B[0] = 0.0;
    coupled_tanks_s_B.B[1] = 0.0;
    coupled_tanks_s_B.Sum[0] = 0.0;
    coupled_tanks_s_B.Sum[1] = 0.0;
  }
  ...
  /* Initialize Sizes */
  coupled_tanks_s_M->Sizes.numContStates = (2);/* Number of continuous states */
  ...
  coupled_tanks_s_M->Sizes.numBlocks = (25);/* Number of blocks */
  coupled_tanks_s_M->Sizes.numBlockIO = (8);/* Number of block outputs */
  coupled_tanks_s_M->Sizes.numBlockPrms = (115);/* Sum of parameter "widths" */
