...
typedef struct {
  real_T VoltstocmTank1;               /* '<S3>/Volts to cm Tank 1 ' */
  real_T VoltstocmTank2;               /* '<S3>/Volts to cm Tank 2' */
...
typedef struct {
  ...
  real_T HILReadAnalog_Buffer[2];      /* '<S3>/HIL Read Analog' */
  t_card HILInitialize_Card;           /* '<S3>/HIL Initialize' */
  void *HILReadAnalog_PWORK;           /* '<S3>/HIL Read Analog' */
  ...
  struct {
    void *LoggedData;
  } Estadosestimados_PWORK;            /* '<Root>/Estados estimados' */
  ...
  struct {
    void *LoggedData;
  } Sinaldeentradau_PWORK;             /* '<Root>/Sinal de entrada (u) ' */
