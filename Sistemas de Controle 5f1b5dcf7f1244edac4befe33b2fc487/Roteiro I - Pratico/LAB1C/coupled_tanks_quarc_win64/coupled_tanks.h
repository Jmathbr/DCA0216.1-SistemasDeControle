...
#ifndef RTW_HEADER_coupled_tanks_h_
#define RTW_HEADER_coupled_tanks_h_
#include <string.h>
#ifndef coupled_tanks_COMMON_INCLUDES_
# define coupled_tanks_COMMON_INCLUDES_
#include "rtwtypes.h"
...
#endif                                 /* coupled_tanks_COMMON_INCLUDES_ */

#include "coupled_tanks_types.h"
...
#define coupled_tanks_rtModel          RT_MODEL_coupled_tanks_T

/* Block signals (auto storage) */
typedef struct {
  real_T VoltstocmTank1;               /* '<S1>/Volts to cm Tank 1 ' */
  real_T VoltstocmTank2;               /* '<S1>/Volts to cm Tank 2' */
} B_coupled_tanks_T;
...
#define rtB                            coupled_tanks_B
#define BlockIO                        B_coupled_tanks_T
#define rtP                            coupled_tanks_P
#define Parameters                     P_coupled_tanks_T
#define rtDWork                        coupled_tanks_DW
#define D_Work                         DW_coupled_tanks_T

/* Parameters (auto storage) */
struct P_coupled_tanks_T_ {
  ...
  boolean_T HILInitialize_set_pwm_params__e;/* Mask Parameter: HILInitialize_set_pwm_params__e
                                             * Referenced by: '<S1>/HIL Initialize'
                                             */
  real_T VoltstocmTank1_Gain;          /* Expression: 1
                                        * Referenced by: '<S1>/Volts to cm Tank 1 '
                                        */
  real_T VoltstocmTank2_Gain;          /* Expression: 1
...
struct tag_RTM_coupled_tanks_T {
  const char_T *path;
...
extern P_coupled_tanks_T coupled_tanks_P;

/* Block signals (auto storage) */
extern B_coupled_tanks_T coupled_tanks_B;

/* Block states (auto storage) */
extern DW_coupled_tanks_T coupled_tanks_DW;

/* Model entry point functions */
extern void coupled_tanks_initialize(void);
extern void coupled_tanks_output(void);
extern void coupled_tanks_update(void);
extern void coupled_tanks_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern coupled_tanks_rtModel *coupled_tanks(void);
...
extern RT_MODEL_coupled_tanks_T *const coupled_tanks_M;
 ...
 *
 * '<Root>' : 'coupled_tanks'
 * '<S1>'   : 'coupled_tanks/PLANTA'
 */
#endif                                 /* RTW_HEADER_coupled_tanks_h_ */
